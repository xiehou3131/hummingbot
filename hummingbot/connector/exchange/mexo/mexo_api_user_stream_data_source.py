...
class MexoAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        ...
        url = f"{CONSTANTS.USER_DATA_STREAM_URL.format(self._domain)}/{self._current_listen_key}"
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        Mexo does not require any channel subscription.
    ...
    async def _get_listen_key(self):
        ...
        try:
            data = await rest_assistant.execute_request(
                ...
                params={"timestamp": self._connector.current_timestamp * 1000},
    ...
    async def _ping_listen_key(self) -> bool:
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.MEXO_USER_STREAM_PATH_URL, domain=self._domain),
                params={"listenKey": self._current_listen_key, "timestamp": self._connector.current_timestamp * 1000},
