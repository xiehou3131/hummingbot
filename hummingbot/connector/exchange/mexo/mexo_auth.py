...
class MexoAuth(AuthBase):
    ...
    async def ws_authenticate(self, request: WSRequest) -> WSRequest:
        """
        This method is intended to configure a websocket request to be authenticated. Mexo does not use this
        functionality
        """
    ...
    def header_for_authentication(self) -> Dict[str, str]:
        return {"X-BH-APIKEY": self.api_key}
