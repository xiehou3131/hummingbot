...
from hummingbot.connector.exchange.mexo.mexo_order_book import MexoOrderBook
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.mexo.mexo_exchange import MexoExchange


class MexoAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    def __init__(self,
                 ...
                 connector: 'MexoExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__(trading_pairs)
        self._connector = connector
        self._trade_messages_queue_key = CONSTANTS.TRADE_TOPIC_TYPE
        self._diff_messages_queue_key = CONSTANTS.DIFF_TOPIC_TYPE
        self._domain = domain
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:
        ...
        snapshot_msg: OrderBookMessage = MexoOrderBook.snapshot_message_from_exchange(
            snapshot,
            snapshot_timestamp,
    ...
    def _channel_originating_message(self, event_message: Dict[str, Any]) -> str:
        ...
        channel = (self._diff_messages_queue_key if event_type == CONSTANTS.DIFF_TOPIC_TYPE
